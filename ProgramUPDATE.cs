...
namespace Testlearning
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (startProgram)
            {
                string filePath = @"/Users/sarahshehri/Documents/Hello.text"; // file pathe

                var lines = File.ReadAllLines(filePath).ToList(); // opject
                Console.WriteLine();
                Console.WriteLine("<< Welcom in Student Mangment >>");
                Console.WriteLine("Choose Operation 1- Add Student 2- Retrieve  Student 3- Update Student   4- Display Student  : any Key to Exit . ");
